...
// var colorA = randomNumber(0, 255).toString();
// var colorB = randomNumber(0, 255).toString();
// var colorC = randomNumber(0, 255).toString();
...
btn.addEventListener("click", () => {
  ...
  var colorB = randomNumber(0, 255).toString();
  var colorC = randomNumber(0, 255).toString();
  document.body.style.background = `rgb(${colorA}, ${colorB}, ${colorC})`;
  console.log("click");
});
