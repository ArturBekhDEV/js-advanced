...
const ITEA_COURSES = ["Курс HTML & CSS", "Курс HTML & CSS1", "JavaScript базовий курс", "JavaScript просунутий курс", "JavaScript Professional", "Angular 2.4 (базовий)", "Angular 2.4 (просунутий)" , "React.js", "React Native", "Node.js", "Vue.js"];
  const NOT_ARRAY = "";

  /*  
      Array.isArray: https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Array/isArray
      Array.isArray();
      Перевірка є масивом: Array.isArray( Arr );
  */
  ...
  */
  ...
  // let index = ITEA_COURSES.indexOf('JavaScript базовий курс');
  ...
  */
  ...
  let filtredArray = ObjArray.filter(removeItem);
  ...
  */
  ...
  /*
    ...
    За замовчуванням сортує за Unicode таблицею.
     Формула сортування:
    
     function compare(a, b) {
       if (a менше b за деяким критерієм сортування) {
         return -1;
       }
       if (a більше b за деяким критерієм сортування) {
         return 1;
       }
       // a має бути рівним b
       return 0;
