...
// // Змінюємо значення вихідного об'єкта та перевіряємо значення обох
// DataObj.data5 = 'data5';
// console.log('DataObj', DataObj);
// console.log('firstAssign', firstAssign);
...
// {},
//  v1 // розбере посимвольно індекс-літера
//  null, // -> ignore
//  v2, // -> ignore
//  undefined, // -> ignore
//  v3, // -> ignore
//  v4, // внесе в об'єкт,
//  v5 // кожен елемент масиву як нова властивість
