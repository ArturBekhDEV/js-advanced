...
let cookieFirst = new CookieMaker("ginger", "150", "red", "white");
let cookieFirst2 = new CookieMaker("ginger", "150", "green", "white");
...
class CookiesContainer {
  ...
  build() {
    ...
    root.innerHTML = arrOfCookies.map(
      (item) => `
...
let arrOfCookies = [cookieFirst, cookieFirst2];
